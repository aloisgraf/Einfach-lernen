    ...
    <div className={`lv-page ${raleway.variable} ${nunito.variable}`}>
      ...
      <section className="sec" style={{ background: "linear-gradient(150deg, var(--sand) 0%, #fdf6e8 55%, var(--pine-pale) 100%)", paddingBottom: "3rem" }}>
        <div style={{ maxWidth: 760, margin: "0 auto", textAlign: "center" }}>
          ...
          <h1 className="sec-title"><RichText text={b.titel} /></h1>
          <p className="sec-sub" style={{ margin: "0 auto" }}>{b.untertitel}</p>
        </div>
      </section>
      ...
      <section className="sec" style={{ background: "var(--white)" }}>
        <div className="content-wrap">
          <RichParagraphs text={b.absatz1} />
          <RichParagraphs text={b.absatz2} />
          <RichParagraphs text={b.absatz3} />

          <div className="price-box">{b.preis_hinweis}</div>

          <RichParagraphs text={b.absatz4} />
          <RichParagraphs text={b.absatz5} />
        </div>
      </section>

      <section className="cta-sec" id="kontakt">
        <h2><RichText text={b.cta_titel} /></h2>
        <div className="tagline">Wo Lernen einfach wird.</div>
        <p>{b.cta_text}</p>
        <div className="cta-btns">
          <a href="mailto:info@einfachlernen-pongau.at" className="btn btn-gold">{b.cta_button1_label}</a>
